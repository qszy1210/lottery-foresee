...
RecommendationKind = Literal["main", "shock"]
...
def recommend_dlt(
    ...
    shock_rng = random.Random(seed if seed is not None else random.randrange(2**31))
    main_combos = [
        DltCombination(fronts=r.fronts, backs=r.backs) for r in main_recs
    ]
